...
//           setSuccess(true) // ✅ trigger snackbar
          
//           // Delay navigation a little so user sees the snackbar
//           setTimeout(() => {
//             navigate('/face')
//           }, 1500)
//         } else {
...
//                 height={400}
//                 onUpdate={(err, result) => {
//                   if (result && scanning && !loading) {
//                     setScanning(false) // 🔒 stop scanning instantly
...
//         message="QR code validated! Redirecting..."
//       />
//     </Box>
//   )
// }
