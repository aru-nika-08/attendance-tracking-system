...
const StudentDashboard = () => {
  ...
  const getStatusColor = (r) =>
    r.present ? "success" : r.status === "late" ? "warning" : "error";
  const percentage =
      ...
      <Container maxWidth="lg" sx={{ mt: 2 }}>
        ...
        <Paper elevation={3} sx={{ p: 3, mb: 3, textAlign: "center" }}>
          ...
          <Button
            variant="outlined"
            startIcon={<History />}
            onClick={() => attendanceAPI.getStudentAttendance(user.email)}
            disabled={loading}
          >
            Refresh
          </Button>
                ...
                <React.Fragment key={i}>
                  <ListItem>
                    ...
                    <ListItemText
                      ...
                      secondary={
                        r.courseName || r.className || "Class Attendance"
                      }
                    />
                  </ListItem>
